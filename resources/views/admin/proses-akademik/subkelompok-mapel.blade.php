...
@section('content')
    ...
    $sub_klp_mapel = new App\Models\SubKelompokMapel();
    $sub_klp_mapel = $sub_klp_mapel->get_sub_kelompok($skl->id_identitas_sekolah);
    @endphp

    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h5 class="text-dark font-weight-bold my-1 mr-5">Sub-Kelompok Mapel</h5>
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="" class="text-muted">Sub-Kelompok Mapel</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Data Sub-Kelompok Mapel
                            <span class="d-block text-muted pt-2 font-size-sm">Kelola data Sub-kelompok mapel</span>
                        </h3>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-head-custom table-checkable" id="dataTable">
                        ...
                        <tbody>
                            @foreach ($sub_klp_mapel as $no => $dta)
                                <tr>
                                    <td>{{ $no + 1 }}</td>
                                    <td>{{ $dta->kelompok_mapel->nama_kelompok_mata_pelajaran }}</td>
                                    <td>{{ $dta->jenis_kelompok_mata_pelajaran_sub }}</td>
                                    <td>{{ $dta->nama_kelompok_mata_pelajaran_sub }}</td>
                                    <td>
...
@section('javascript')
    <script>
        $(document).ready(function() {
            $('#nav-subkelompok-mapel').addClass('menu-item-active').parents('.menu-item-submenu').addClass(
