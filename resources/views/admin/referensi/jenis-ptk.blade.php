...
@section('content')
    ...
    $jenis_ptk = new App\Models\JenisPtk();

    $jenis_ptk = $jenis_ptk->where('id_identitas_sekolah', $skl->id_identitas_sekolah)->get();
    @endphp

    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h5 class="text-dark font-weight-bold my-1 mr-5">Jenis PTK</h5>
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="" class="text-muted">Jenis PTK</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Data Jenis PTK
                            <span class="d-block text-muted pt-2 font-size-sm">Kelola data Jenis PTK</span>
                        </h3>
                    </div>
...
@section('javascript')
    <script>
        $(document).ready(function() {
            $('#nav-jenis-ptk').addClass('menu-item-active').parents('.menu-item-submenu').addClass(
