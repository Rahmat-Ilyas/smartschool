    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h5 class="text-dark font-weight-bold my-1 mr-5">Data Alat Pecah</h5>
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="" class="text-muted">Data Alat Pecah</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Data Data Alat Pecah
                            <span class="d-block text-muted pt-2 font-size-sm">Kelola data alat pecah</span>
                        </h3>
                    </div>
                    ...
                    <table class="table table-separate table-head-custom table-checkable" id="dataTable">
                        ...
                        <tbody>
                            @foreach ($lab_kasus as $no => $dta)
                                <tr>
                                    <td>{{ $no + 1 }}</td>
                                    <td>{{ $dta->siswa->nama }}</td>
                                    <td>{{ $dta->nama_pratikum }}</td>
                                    <td>{{ $dta->tempat_praktek }}</td>
                                    <td>{{ $dta->waktu_praktek }}</td>
                                    <td>{{ $dta->kelompok }}</td>
...
@section('javascript')
    <script>
        $(document).ready(function() {
            $('#nav-lab-data-alat').addClass('menu-item-active').parents('.menu-item-submenu').addClass(
